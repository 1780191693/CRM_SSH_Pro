...
<BODY>
<FORM id=form1 name=form1 action="<s:url action="user_login"/>" method=post target="_parent">
          ...
          <TD>
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD>
                  <INPUT id=btn1
                  style="BORDER-TOP-WIDTH: 0; BORDER-LEFT-WIDTH: 0; BORDER-BOTTOM-WIDTH: 0; BORDER-RIGHT-WIDTH: 0"
